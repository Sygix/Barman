...
module.exports = class r6sStats {
    constructor() {

    }

    stats(username, platform, operators, seasons) {
        return new Promise((resolve, reject) => {
            ...
            if(seasons) {
                endpoint = `https://api.r6stats.com/api/v1/players/${username}/seasons/?platform=${platform}`;
            }
